  ...
  render() {
    ...
    return (
      <section>
                      ...
                      <div id="node-34" className="node node-page clearfix">
                        ...
                        <div className="content">
                          <div className="field field-name-body field-type-text-with-summary field-label-hidden"><div className="field-items"><div className="field-item even">
                            <p>Here you'll find all the latest talks and current sermon series we're doing at Horsham Presbyterian Church. Feel free to browse around and check out the different talks.
                            We've also highlighted a couple of talks that we think could be really valuable if you're new to Christianity, or if you're new to Horsham Presbyterian Church and want to find out what we're all about.
                            </p>
        ...
        <div className="content-1 bg-color-custom">
          <div className="container">
            <div className="row">
